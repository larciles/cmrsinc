...
let Exisminima   = 0;
let Exismaxima   = 0;   
let Prod_serv    = $("input[name=optradio1]:checked").attr("id").substring(0,1);
...
if ($("input[name=optradio1]:checked").attr("id")=='S-003') {
   cod_subgrupo = 'CONSULTA' ; 
}else if($("input[name=optradio1]:checked").attr("id")=='S-004'){
   cod_subgrupo = 'SUEROTERAPIA' ; 
}else if($("input[name=optradio1]:checked").attr("id")=='M-004'){
   cod_subgrupo = 'TERAPIA LASER' ;
}

let codgrupo     = $("input[name=optradio1]:checked").attr("id").substring($("input[name=optradio1]:checked").attr("id").indexOf("-")+1) ;
let costo        = 0;  
