    ...
    for (var i = 0; i < lenArr; i++) {
        ...
        // total = parseFloat(total)-parseFloat(descuento)
         ...
         $('#tbldevol').append('<tr id='+numnotcre+'>'+
          ...
          ' <td align="center"> <button type="button" name="print"  id=""  class="btn btn-success print '+pagado+' ">Imprimir</td>'+          
   ...
   if(elemt.attr('class').indexOf("void")>-1) {
      ...
      var result = numfactu.split('-');
       if(result.length==1){
          ...
          window.location.href = "mslaser-ret.php?edicion=true&numero="+numfactu;           
       }
