...
function  buildTabla(data){
     var arr1=[],arr2=[],arrprincipal=[],arrGraph=[],arrGrapTotal=[],arrGrapSINTotal=[],arrGrapNOTotal=[];
     var arrGrapTotal=[]
     var arrTotal=[]
     var data1=data;
     data1[0][0] = data1[0][0].substring(1);    
     ...
     arrGrapTotal.push(arrTotal); 
     buildTablaReport(arrprincipal);

};
//--------------------------------------------------------------------------------------
function buildTablaReport(tabledata){ 
  len=data.length-1;
  data1=data;
  var arr1=[];
  var arrprincipal=[];
...
var DATA 	= [];
  var type    =  $('#tipo').val();
	...
	var titulo = $("#tipo option[value="+$('#tipo').val()+"]").text();
    var datarow =[];
    var sales_   =  reportData(type,sd,ed,"");
    let sales=sales_[0]; //PARA LAS GRAFICAS
