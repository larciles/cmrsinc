...
$('#medico').change(function(){
 ...
 $(document).ready(function(){  
  ...
  $('#xtitulo').html('<b>Facturación Consultas y Servicios</b>');
      var i=1; 
      i=document.getElementById('dynamic_field').rows.length-1 ;
      $('#add').click(function(){  
           i++;  
           var idpro="serv"+i;
           var idtpr="tpre"+i;
...
// 
  ...
  function setConsultas(id,data,type){
    ...
    var serv= getDataPost("../../clases/serviciossuero.php",data,type);
    ...
    function getDataPost(url,data,type){
  if (data==undefined) {
    data = {    }
  };
  if (type==undefined) {
  ...
  // }
   ...
   if ($('#serv1').text().trim()=='') {
     setConsultas('serv1',{servicio:'S', orderby:'desitems',grupo:'004'},'POST'); ///setConsultas('serv1');
...
//**************
      $(".delete-row").click(function(){
            ...
            var facturaNum =   $('#invoicen').attr('value').trim(); //$('#invoicen').val().trim();
        ...
        for (var i = 0; i < arraySubTotl.length; i++) {
          if ( $("input[name='name[]']")[i].value!=="" &&  $("select[name='serv[]']")[i].value!=="") {
              ...
              lineSubtotal=lineSubtotal + parseFloat( $("input[name='name[]']")[i].value ) ; //parseFloat(document.forms[0].elements["name[]"][i].value);
               ...
               var ed=$("input[name='descuento[]']")[i];                              
               $("input[name='descuento[]']")[i].value = ''; 
               ed.setAttribute('value','0')
              ...
              if ($('#discprcntg').val()!=="" && $('#discprcntg')!==0) {
                   ...
                   ed.setAttribute('value',round(desc,2))
