...
$('#xtitulo').html('<b>Células Madres</b>');
$('#titulografica').hide();
...
function reportes(id,titulo){
  ...
  let codpro = $('#sltprod').val();
  
  
  titulo ='Reporte de Celulas Madres';
...
//repreturnsproducto.php
  window.open('celmadresrep.php?fecha='+fecha+
                                  '&usuario='+usuario+
                                  '&titulo='+titulo+                               
                                  '&fecha2='+fecha2                                  
                                  ,'','_blank');
...
function getSelectOpProd1(){
    data = {
    prod_serv : "p",
    orderby   : "desitems"
  }
    var res = getData("../../clases/getbloqueo.php",data);
