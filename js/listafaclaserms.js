...
getLaserInvoices();
  ...
  function getLaserInvoices(  page,  search,  fecha){
    ...
    for (var i = 0; i < lenArr; i++) {
        ...
        if ( parseFloat( items['data'][i]["monto_abonado"])==0) {
            pagado="sin-pagar";
             fa.push(numfactu); 
        }
        ...
        total = parseFloat(total).toFixed(2)
         ...
         $('#tblLista').append('<tr id='+numfactu+' class="'+clase+clasemiss+'">'+
          ...
          ' <td align="right">'+record+'</td>'+
         	...
         	' <td align="center"> <button type="button" name="imprimir"  id="imprimir" class="btn btn-success btn_imprimir '+pagado+' ">Imprimir</button> </td>'+
