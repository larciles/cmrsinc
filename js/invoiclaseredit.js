...
if (items[0].statfact=='3' || items[0].statfact=='2') {
  $("#discprcntg").attr("disabled", true);
...
$('#medico').change(function(){
 ...
 $(document).ready(function(){  
  ...
  $('#xtitulo').html('<b>Edición Laser</b>');
      var i=1;  
      $('#add').click(function(){  
           i++;  
           var idpro="serv"+i;
 ...
 if ($('#serv1').text().trim()=='') {
   ...
   $('#dynamic_field').on('change', 'tbody tr td select', function(event) {
      ...
      if($(this).parent().parent().hasClass("highlight")   || $(".service").is(":focus") ){
         ...
         coditems  = $("[name='serv[]']")[row_index].value
         ...
         codtipre  =  $("[name='listaprecio[]']")[row_index].value  
...
$(".delete-row").click(function(){
             ...
             var facturaNum = $('#invoicen').attr('value').trim();
            ...
            var select = document.getElementById("serv1");
...
function ajustaInventario(producto,facturaNum,cantidad){
    ...
    $.ajax({                
          url:"../../clases/updatelaserinvoice.php",  
          method:"POST",  
          data: data ,  
          success:function(data)  
          {               
...
function loadIdsAsociados(items){    
 var options=""; 
  ...
  $('#save').click(function(){
    ...
    var tdc1  =$('#tdc1').val(); 
    var radio1=$(".optradio1").attr('id'); //eletdc1;

    var tdc2  =$('#tdc2').val();  
    var radio2=$(".optradio2").attr('id'); //eletdc2; 

    var tdc3  =$('#tdc3').val(); 
    var radio3=$(".optradio3").attr('id'); // eletdc3;   
...
if (res!==null) {
  for (var i = 0; i < res.length; i++) {
       ...
       if (codtarjeta=="00"  && pago>0) {
          ...
          $('#tdc1').prop('readonly', false);
           if($('#tdc1').val()==""){              
               setValueAndCheck('tdc1',pago,codtarjeta,idcard);
           }else if($('#tdc2').val()==""){
             $('#tdc2').prop('readonly',false);
             setValueAndCheck('tdc2',pago,codtarjeta,idcard);              
           }else if($('#tdc3').val()==""){
              $('#tdc3').prop('readonly',false);
              setValueAndCheck('tdc3',pago,codtarjeta,idcard);             
           }
...
//*********************************************************************
function setValueAndCheck(id,value,card,idcard){
...
//*********************************************************************
function setIDCardNumber(id,idcard){
  if (id == 'tdc1') {
     $('#card1').val(idcard);
  }else if(id =='tdc2'){
     $('#card2').val(idcard);
