 $(document).ready(function(){  
  ...
  $('#xtitulo').html('<b>Ajuste de Inv3ntario</b>');
      var i=1;  
      $('#add').click(function(){  
           i++;  
           var idpro="serv"+i;
             ...
             let dts = $('#add_name').serialize();
               $.ajax({  
                    ...
                    {  
                          ...
                          document.getElementById("aj-alert").style.display = "block";
...
$('body').on('keydown', 'input, select, textarea', function(e) {
    ...
    if (e.keyCode == 13) {
        ...
        if(self.hasClass('cantidad')){
            next = focusable.eq(2);   //INDICE DEL BOTON ADD MORE
        }else{
...
$('#aj-alert').on('close.bs.alert', function () {
