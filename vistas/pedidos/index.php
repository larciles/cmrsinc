...
require "../../controllers/po_controller.php";
		...
		<section class="main row">
			<article class="col-md-2">
				...
				<form action='index.php' method='post'>
					...
					<input  id="typepedido" type="hidden"  name="typepedido" value=<?php if(isset($_POST["typepedido"])){ echo $_POST["typepedido"];} else{ echo "true";}?> >
					     ...
					     <div class="form-group">
						    <div class="col-sm-4">
						       ...
						       <input type="text" id="meses" name="meses" class="form-control" value= <?php if(isset($_POST["meses"])){ echo $_POST["meses"];} else{ echo "3";}?>>
					            ...
					            <!-- <input type="checkbox" class="tipopedido" name="tipopedido"  checked data-toggle="toggle" data-on="Productos" data-off="Intravenoso" data-onstyle="success" data-offstyle="info">  -->

					        <div class="col-sm-2">
					        	<label for="">Pedido</label>
                                <?php 
                                  if(isset($_POST["typepedido"])){
                                  	if ($_POST["typepedido"]=="true") {
                                  	?>	
                                        <input type="checkbox" class="tipopedido" name="tipopedido"  checked data-toggle="toggle" data-on="Productos" data-off="Intravenoso" data-onstyle="success" data-offstyle="info">  		
                                   <?php      
                                  	} else {
                                  	?>
                                  		<input type="checkbox" class="tipopedido" name="tipopedido"   data-toggle="toggle" data-on="Productos" data-off="Intravenoso" data-onstyle="success" data-offstyle="info">  		
                                  	<?php 	
                                  	}                                  	
