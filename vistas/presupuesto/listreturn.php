        ...
        <div class="control-group col-sm-3">
               ...
               <div class="form-group">
                <!-- data-tip="Id, Record, Nombres,  Apellidos, Médico, Teléfonos, Observación o Código" -->
                  <div>
                    <input type="text" class="form-control" id ="searchd" name="searchd" placeholder="Buscar">
                  </div>
               </div>
        </div>
        <div class="col-sm-2"> 
           <label class="control-label"></label>  
           <div class="form-group">
              <input class="datepickerd form-control" data-date-format="mm/dd/yyyy">
           </div>
        </div>
   </div>

<table id='tblreturn' class='table table-bordered table-hover table-condensed table-striped'>  
