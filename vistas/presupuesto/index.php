...
<!--         <link rel="stylesheet" href="../../css/bootstrap.min.css"/>
      ...
      <body>  
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#menu1">Presupuestos</a></li>
          ...
          <!-- tabs -->          
              <form name="add_name" id="add_name">  
                    ...
                    <div class="row">
                      ...
                      <!-- /.col -->
                      <div class="col-xs-6">
                        <p class="lead" id="fechaf">  <span id="invoicen">  Presupuesto # 123455</span></p>
                  ...
                  <div class="col-xs-12" >
                    ...
                    <!-- <button class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</button>  -->
                        ...
                        <input type="button" name="printpre"  id="printpre" class="btn btn-info" value="Imprimir" style="float: right;margin-right: 191px;margin-top: -46px;display:none" />  
...
<script src="../../js/listpresupuestos.js"></script>
