...
require_once '../../controllers/returnprodcontroller.php';
$numfactu = $_GET['fac'];
//var_dump($_GET);
         ...
         <!--                   <div id="dividasegurohd" class="form-group col-sm-2">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="button" name="nueva" id="nueva"  style="display:none" class="btn btn-primary pull-left" value="Nueva factura" />  
                    </div>
                    </div>
                    </div>
              </form>
...
<script src="../../js/returnprod.js"></script>
