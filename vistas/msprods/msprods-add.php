...
$cmamfacturacontroller = new MFacturaController();

$cmadfacturacontroller = new DFacturaController();
...
if (isset($_GET['edicion']) && $_GET['edicion']=="true") {
  ...
  $res = $cmamfacturacontroller->readUDF("Select *, REPLACE(CONVERT(CHAR(15), fechafac, 101), '', '-') AS fecha  from mfactura where numfactu='$numfactu' " );
}else{
  $res = $cmamfacturacontroller->readUDF("Select *,REPLACE(CONVERT(CHAR(15), fechafac, 101), '', '-') AS fecha  from mfactura where cempresa='p' and statfact='1' and usuario='$user' and fechafac='$fecha' " );
}
...
if ( sizeof($res)>0 ) {
    ...
    $detf = $cmadfacturacontroller->readUDF("Select * from dfactura where numfactu='$factura' " );
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th>Tax (10.5% + 1%)  : <input checked data-toggle="toggle" data-size="small" type="checkbox" id="taxapply" name="taxapply" ></th>
                                  <td >
                                    <input type="text"  id="tlimpuesto" name="tlimpuesto" value="<?php if(sizeof($res)>0 ) echo( number_format((float)  $res[0]['TotImpuesto']  ,  2, '.', '')  ) ; ?>" style="text-align:right;" class="form-control name_list"  />
...
<script src="../../js/msprods.js?v=20200109-1"></script>
<script src="../../js/msprodspayments.js?v=20200117"></script>
<script src="../../js/listprodinvoice.js?v=22"></script>
<script src="../../js/productosvoid.js?v=20190918"></script>
<script src="../../js/getsalesrecord.js"></script>
<script src="../../js/listdevprodinvoice.js"></script>
