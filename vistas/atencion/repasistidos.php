...
<body>
  ...
  <ul class="nav nav-tabs" id="tabs">
      <li class="active"><a data-toggle="tab" href="#home">Asistidos</a></li>
      <li><a data-toggle="tab" href="#menu1">Estadísticas</a></li>              
  </ul>
  ...
  <div class="tab-content">  
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="row">       
        <p  id="titulo" align="center" style="font-size:18px;" >Asistidos</p>
      </div> 
  ...
  <div id="menu1" class="tab-pane fade">
      <?php include 'estadisticasasistidos.php';?>    
  </div>    
...
<script src="../../js/repasistidos.js"></script>
