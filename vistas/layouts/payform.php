    ...
    <div class="modal-content">
      ...
      <div class="row">
          <div class="col-xs-6 form-group">
            ...
            <input type="text" class="form-control" id="dueamount" autocomplete="off">
          </div>
          <div class="col-xs-6 form-group">
            <label for="message-text" class="form-control-label pay">Cambio:</label>
             <input type="text" class="form-control" id="cambio" autocomplete="off">
          </div>
      </div>
    ...
    <tbody>
      ...
      <div class="row">
          <div class="col-xs-6 form-group">
            ...
            <input type="text" class="form-control" id="pagototal" autocomplete="off">
          </div>
          <div class="col-xs-6 form-group">
            <label for="message-text" class="form-control-label">Saldo:</label>
             <input type="text" class="form-control" id="saldo" autocomplete="off">
          </div>
      </div>
