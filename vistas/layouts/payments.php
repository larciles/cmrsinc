  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <tbody>
      <tr>
        ...
        <td> <input type="text" class="form-control pay" id="tdc1" placeholder="Amount $" readonly="readonly"  autocomplete="off"></td>
        ...
        <td> <input type="text" class="form-control " name="card1" id="card1" placeholder="Ultimos 4 numeros"  autocomplete="off"></td>      
      </tr>
      <tr>
        <th scope="row">Card # 2 $</th>
        <td> <input type="text" class="form-control pay" id="tdc2" placeholder="Amount $" readonly="readonly"  autocomplete="off"></td>
        ...
        <td><input type="text" class="form-control " name="card2" id="card2" placeholder="Ultimos 4 numeros"  autocomplete="off"></td>      
      </tr>
      <tr>
        <th scope="row">Card # 3 $</th>
        <td> <input type="text" class="form-control pay" id="tdc3" placeholder="Amount $" readonly="readonly"  autocomplete="off"></td>
        ...
        <td><input type="text" class="form-control " name="card3" id="card3" placeholder="Ultimos 4 numeros"  autocomplete="off"></td>      
      ...
      <tr>
        ...
        <td><input type="text" class="form-control pay" name="check" id="check" placeholder="Cheque / Check $"  autocomplete="off"></td>      
      </tr>
    </tbody>
  </table>
