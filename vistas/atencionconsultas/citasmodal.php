<!-- start modal --> 
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" cconsulta-id="" aria-hidden="true">
        ...
        <form>
          ...
          <div class="form-group col-sm-4">
           <!--  <label for="recipient-name" class="form-control-label">Recipient:</label> -->
            <input type="text" id="idpaciente" class="form-control" placeholder="Record Id Nombres" autocomplete="off">
          </div>
          ...
          <div  class="form-group col-sm-3" id="fgfechacita">
                <div class="form-group">    
                    <input type="text" class="form-control datepicker" id="fechaNewApmt" placeholder="MM/DD/YYYY"   name="fechaNewApmt" autocomplete="off">
                </div>    
          </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="btn-group btn-group-toggle form-group col-sm-7 tipo_citas" data-toggle="buttons">
            ...
            <label class="btn btn-secondary">
                <input type="radio" name="options" id="option2" autocomplete="off"> Bloqueo
            </label>

            <label class="btn btn-secondary">
                <input type="radio" name="options" id="option3" autocomplete="off"> Cel Madres
            </label>
        </div>
