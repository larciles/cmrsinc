...
$facturacontroller = new MSSMFactController();
...
if (isset($_GET['return']) ) {
   ...
   $res=$facturacontroller->readUDF("Select *, REPLACE(CONVERT(CHAR(15), fechafac, 101), '', '-') AS fecha from MSSMFact where numfactu='$numfactu' " );
   $long=0;
   if (is_array($res)) {
      $long=sizeof($res);
   }
  ...
  $return=$_GET['numero'];
  $res=$mnotacreditoController->readUDF("Select *, REPLACE(CONVERT(CHAR(15), fechanot, 101), '', '-') AS fecha from MSSMDev where numnotcre='$return' " );
  $long=0;
  if (is_array($res)) {
      $long=sizeof($res);
  }
                  ...
                  <form name="facturacion" id="facturacion" method="post">  
                    ...
                    <div class="container-fluid ">                           
                          ...
                          <div id="dividassoc" class="form-group col-sm-2">
                              ...
                              <input  id="idassochd" type="hidden" name="idassochd" required>
                        ...
                        <div class="table-responsive">
                          <table class="table">
                            <tbody>
                              <tr>
                               ...
                               <tr>
                                ...
                                <?php
                                  ...
                                  if (sizeof($res)>0 && $porcentaje>0) {
                                     
                                    ?>
                                      <th><input type="text" id="discprcntg" name="discprcntg" value="<?php if(sizeof($res)>0 ){ echo( number_format((float)  $porcentaje ,  2, '.', '')  ) ;} else{ echo("");} ?>"  style="text-align:right;" placeholder="Discount %" class="form-control name_list discount" <?php ?> /></th>
                              ...
                              <tr>
                                <th>Total:</th>
                                <td><input type="text"  id="tltotal" name="tltotal"  value="<?php if(sizeof($res)>0 ) echo( number_format((float)  $total ,  2, '.', '')  ) ; ?>" style="text-align:right;" class="form-control name_list" readonly /></td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                    ...
                    <div class="row no-print">
                          <div class="col-md-12 ">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                     <input type="button" name="nueva" id="nueva" class="btn btn-primary pull-left" value="Nueva Devolución" style="" /> 
...
<script src="../../js/mslaserret.js?v=20200727"></script>
<script src="../../js/mslaserretpayments.js?v=12"></script>
