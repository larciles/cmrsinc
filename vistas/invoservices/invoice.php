        ...
        <div class="tab-content">
          ...
          <!-- tabs -->          
              <form name="add_name" id="add_name">  
                    ...
                    <input  id="grupo"  type="hidden"  name="grupo" value="CONSULTA">
                    ...
                    <input  id="windows-size" type="hidden" name="windows-size" value=<?php echo $windows;?>>
...
<script src="../../js/consultas.js?v=11919"></script>
<script src="../../js/listafacconsultas.js?v=229"></script>
