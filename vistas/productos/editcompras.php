...
require_once '../../controllers/comprasloadeditcomp.php';

if (isset($_GET['idcompra']) && $_GET["idcompra"]!='') {
                    ...
                    <div class="container-fluid "> 
                          ...
                          <input  id="idusr" type="hidden" name="idusr" value=<?php echo $user;?>>
                           <div class="form-group col-sm-2">  
                                ...
                                <input type="text" id="idcompra" name="idcompra" class="form-control " readonly placeholder="Compra"  <?php if (isset($_GET['idcompra']) && $_GET["idcompra"]!='') { echo "value="."'$idcompra'";}?>>
                          </div>
<!--                           <div class="form-group col-sm-2">
...
<!--                           <div class="form-group col-sm-1">  
 ...
 -->
                  ...
                  <div class="col-xs-12">
                    <div class="col-sm-2"> 
                        <input type="button" name="savecompra" id="savecompra" class="btn btn-info" value="Guardar" style="display:none;" />  
                    </div>
                    <div class="col-sm-2"> 
                        <input type="button" name="saveinv" id="saveinv" class="btn btn-info" value="Guardar y Transferir al Inventario" style="display:none;"  />  
                    </div>
                  </div>
...
<script src="../../js/comprasedit.js"></script>
