...
require_once '../../controllers/devolucioneditlasercontroller.php';
   ...
   <html>  
      ...
      <body>  
        ...
        <?php include('payments.php'); ?> 
              ...
              <form name="returnserv" id="returnserv"  method="POST">  
                ...
                <input  id="factura" type="hidden" name="factura"> 
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                    <div class="col-sm-2"> 
                        <input type="button" name="submit" id="submit" class="btn btn-info" disabled value="Guardar" style="display: none;" />  
                    </div>
                    </div>
                    <div  class="form-group">
                    <div class="col-sm-2">
...
<script src="../../js/devolucionlaseredit.js"></script>