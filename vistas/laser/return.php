...
require_once '../../controllers/returnlasercontroller.php';
   ...
   <html>  
      ...
      <body>  
        ...
        <?php include('payments.php'); ?> 
              ...
              <form name="returnserv" id="returnserv">  
                ...
                <input  id="factura" type="hidden" name="factura" value=<?php echo $numfactu;?>>
...
<script src="../../js/returnlaser.js"></script>