 ...
 ?>
   <html>  
      ...
      <body>  
        ...
        <?php include('modaldevvoid.php'); ?> 

        <!-- tabs -->
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#home">Home</a></li>
            <li><a data-toggle="tab" href="#menu1">Lista de Facturas</a></li>
            <li><a data-toggle="tab" href="#devol">Lista de Devoluciones</a></li>
        </ul>
        <div class="tab-content">
              ...
              <form name="add_name" id="add_name">  
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="button" name="nueva" id="nueva" class="btn btn-primary pull-left" value="Nueva factura" style="display: none;" />  
                    </div>
                    </div>
                    </div>
              </form>
          ...
          <div id="devol" class="tab-pane fade">
              <!-- <h3>List</h3>
               <p>Some content in menu 1.</p> -->
              <!-- tab 2 -->
                <div class="container-fluid">
                <div class="tblcontrol" style="padding-left: 10px; padding-right: 10px;">
                <?php include('devolucionlist.php');?>
                </div>        
               </div>
              <!-- /tab 2 -->              
          </div>
...
<script src="../../js/laser.js?v=305"></script>
<script src="../../js/listafaclaser.js?v=28"></script>
<script src="../../js/listadevollaser.js?v15"></script>
