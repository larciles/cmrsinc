...
// require_once '../../controllers/returnconsultascontroller.php';
require_once '../../controllers/returndisplaycontroller.php';
              ...
              <form name="returnserv" id="returnserv" action="../../clases/savedevservicios.php" method="POST">  
                ...
                <input  id="ipaddress" type="hidden" name="ipaddress" value=<?php echo $ipaddress;?>>
                    ...
                    <div class="container-fluid ">                           
                          <input  id="idusr" type="hidden" name="idusr" value=<?php echo $user;?>>
                           <div class="form-group col-sm-2">  
                                ...
                                <input type="text" name="idpaciente" id="idpaciente" class="form-control" placeholder="Id / Record / Nombre">
                          </div>
                    ...
                    <div class="row">
                      ...
                      <!-- /.col -->
                      <div class="col-xs-6">
                        <p class="lead" id="fechaf">  <span id="invoicen" value=<?php echo "$numfactu";?>>   Return # <?php echo "$numfactu";?></span></p>
...
<script src="../../js/returndisplay.js"></script>