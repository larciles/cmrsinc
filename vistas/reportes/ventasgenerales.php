...
<div class="row">  
  <h2 style="width:100%;text-align:center;position:relative;">Ventas Generales</h2> 
</div>  
  ...
  <table class="table  table-hover table-condensed table-striped" id="dynamic_field">                                      
      <thead class='thead-inverse'>
          <tr>
              ...
              <th class='titleatn' >Empresa</th>
              <th class='titleatn' >Codigo</th>
              <th class='titleatn' >#Visitas</th>
...
<script src="../../js/ventasgenerales.js"></script>
