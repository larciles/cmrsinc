...
<div class="row">
    <div class="container">
      ...
      <div class="col-sm-2">
             <label class="control-label"></label> 
          <div class="form-group">
              <!-- <input type="checkbox" class="titulo" checked data-toggle="toggle" data-on="Todos" data-off="Por Medico" data-onstyle="success" data-offstyle="info" > -->
              <input type="text" class="form-control" id ="search" name="search" placeholder="Record">
          </div>
      </div>

      <div class="col-sm-4" style="display: none;" id="divmedicos"> 
            <!-- <label class="control-label"></label> 
            <div class="form-group">  
...
<div class="row">  
  <h2 style="width:100%;text-align:center;position:relative;">Qué pasó con mi paciente?</h2> 
  <h2 id="patient" style="width:100%;text-align:center;position:relative;"></h2> 
</div>  
<!-- style="width: 900px; height: 300px; display: inline-block;" -->
<div   class="row" >
<div  class="col-sm-12">  
     <div strong class='pagina' style="width:100%;text-align:center;position:relative;">  </div>
</div>
</div>
  ...
  <table class="table  table-hover table-condensed table-striped" id="dynamic_field">                                      
      <thead class='thead-inverse'>
          <tr>
              ...
              <th class='titleatn' >Consulta</th>
              <th class='titleatn' >Observación</th>             
              <th class='titleatn' >Código</th>
...
<script src="../../js/whwmypatient.js"></script>
