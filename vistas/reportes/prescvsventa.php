...
<div class="row">
    ...
    <div class="col-sm-2"> 
          ...
          <div class="form-group">
              <input type="checkbox" class="titulo" checked data-toggle="toggle" data-on="AMNI-SUERO" data-off="TODOS" data-onstyle="success" data-offstyle="info">
          </div>  
    </div>
      <div class="col-sm-2">    
        <label class="control-label"></label> 
...
<script src="../../js/prescritovsventa.js?v=1219_4"></script>
