...
<div class="row">  
  <h2 style="width:100%;text-align:center;position:relative;">Exosomas y Bloqueos  resumen de Ventas ( Por cajero ) </h2> 
</div>  
  ...
  <table class="table  table-hover table-condensed table-striped" id="dynamic_field">                                      
      <thead class='thead-inverse'>
          <tr> 
              ...
              <th class='titleatn' style='text-align: right;'>Venta</th>
...
<script src="../../js/ventasporcajeroexos.js?v=0707"></script>
