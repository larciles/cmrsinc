...
<!--       <div class="col-sm-2">
          ...
          <div class="form-group">
              <input type="checkbox" class="titulo" checked data-toggle="toggle" data-on="Todos" data-off="Por Productos" data-onstyle="success" data-offstyle="info">
          </div>
      </div>
 -->
      <div class="col-sm-2">    
...
<script src="../../js/promeddescrep.js"></script>
