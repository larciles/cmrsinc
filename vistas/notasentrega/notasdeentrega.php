...
//var_dump($_GET);
 ...
 ?>
   <html>  
      ...
      <body>  
        ...
        <?php include('modalneprodentregados.php');?>  

        <!-- tabs -->
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#home">Home</a></li>
            <li><a data-toggle="tab" href="#menu1">Lista Notas Entrega</a></li>
                    ...
                    <div class="container-fluid ">                           
                          <input  id="idusr" type="hidden" name="idusr" value=<?php echo $user;?>>
                           <div class="form-group col-sm-2">  
                                ...
                                <input type="text" id="idpaciente" class="form-control idpaciente" placeholder="Id / Record / Nombre">
                          </div>
 ...
 -->
                           ...
                           <!--    <label class="control-label">Seguro</label>    
                              ...
                              <select id="seguro" name="seguro" class="form-control enterkey" >
                                   <option value="" selected ></option>             
                              </select> -->
                               <label class="control-label">Nota</label>     
                                <input type="text" id="observacion" name="observacion" class="form-control observacion" placeholder="Nota">
                          </div>
                          ...
                          <div class="col-sm-2">    
                                    <label class="control-label">Historial de Compras</label> 
                                      <div class="form-group">  
...
<!--                         <p class="lead">Payment Methods:</p>
 ...
 -->                      </div>
                      <!-- /.col -->
                      <div class="col-xs-6">
                         <p class="lead" id="fechaf">Nota de Entrega #  <span id="invoicen">   Invoice # 123455</span></p>
...
<!--                        <div class="table-responsive">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="col-sm-2"> 
                        <input type="button" name="submit" id="submit" class="btn btn-info" value="Guardar e Imprimir" />  
                    </div>
                    </div>
                    <div  class="form-group">
                    <div class="col-sm-2">
...
<script src="../../js/notasdeentrega.js"></script>
<script src="../../js/listnotaentregarep.js"></script>
