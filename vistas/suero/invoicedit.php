...
require_once '../../controllers/envoiceditcontroller.php';
                                ...
                                <!-- desde aqui -->
                                     ...
                                     <!-- S serv -->
                                      ...
                                      <!-- Ends Seguros -->
                                        ...
                                        <td>
                                          <input type="text" name="descuento[]"  id="descuento1" placeholder="Descuento" class="form-control descuento numbersporcent" style="float: right"/>
                                        ...
                                        <td><input type="text" name="name[]" id="st1" value=""  placeholder="Subtotal" class="form-control name_list listsubtotal" /></td>  
...
<script src="../../js/invoicesueroedit.js?v=11"></script>