            ...
            <div class"tblsin" style="padding-left: 10px; padding-right: 10px;">
                <div class="control-group col-sm-2">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fecha_slanoasis" placeholder="MM/DD/YYYY" name="fecha_slanoasis"  >
                ...
                <div class="control-group col-sm-2">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fecha_slanoasis2" placeholder="MM/DD/YYYY" name="fecha_slanoasis2"  >
                ...
                <div class="form-group col-sm-2">
                    <label class="control-label"></label> 
                    <div class="form-group">  
                        <button type="button"  class="btn btn-success form-control" id="print_slanoasis" >Imprimir</button>
                    </div>
                </div>
