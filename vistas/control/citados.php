<div class="container-fluid">
            ...
            <div class"tblsin" style="padding-left: 10px; padding-right: 10px;">
                <div class="control-group col-sm-2">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fecha_cit" placeholder="MM/DD/YYYY" name="fecha_cit"  >
                ...
                <div class="control-group col-sm-2">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="fecha_cit2" placeholder="MM/DD/YYYY" name="fecha_cit2"  >
    ...
    <!--             <div class="form-group col-sm-2">
                ...
                <div class="form-group col-sm-2">
                    <label class="control-label"></label> 
                    <div class="form-group">  
                        <button type="button"  class="btn btn-success form-control" id="print_cit" >Imprimir</button>
                    </div>
                </div>
            </div>               
        </form>
