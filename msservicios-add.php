...
if (isset($_GET['edicion']) && $_GET['edicion']=="true") {
  ...
  $res = $cmamfacturacontroller->readUDF("Select *,REPLACE(CONVERT(CHAR(15), fechafac, 101), '', '-') AS fecha  from cma_mfactura where cempresa='s' and statfact='1' and usuario='$user' " );
}
...
<script src="../../js/msservicios.js"></script>
<script src="../../js/msserviciospayments.js"></script>
<script src="../../js/listafacserviciosmss.js"></script>
