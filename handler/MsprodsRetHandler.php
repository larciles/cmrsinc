...
//------------------------------------------------------------------
 ...
 function deleteRecords($invoiceNumber,$allYN,$coditems){
   ...
   if ($allYN==true) {
    ...
    $mpagosController->del($invoiceNumber,'1','04');
    $idcardController->del($invoiceNumber,'1','04');
...
function save($factura){
    ...
    if (trim($factura)=="") {
        $factura=$empresacontroller->getLastNumber('return','1',7);
           ...
           if(trim($_POST["producto"][$i] !='')){
               ...
               $dosis=(int)$_POST['dosis'][$i];
                ...
                $set_data = array(
                   ...
                   ,'dosis' =>$dosis
                   ,'cant_sugerida'=>(int)$_POST['sugerido'][$i]
                   ,'tipoitems'=>'p'
