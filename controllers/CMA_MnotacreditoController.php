...
try {
  if(!include('../../models/CMA_MnotacreditoModel.php'))
        include('../models/CMA_MnotacreditoModel.php');
} catch (Exception $e) {
  var_dump($e)  ;
}


class CMA_MnotacreditoController{
    private $model;

    public function __construct(){
        $this->model = new  CMA_MnotacreditoModel();
    }
