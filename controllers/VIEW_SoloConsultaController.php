...
try {
  if (!include('../../models/VIEW_SoloConsultaModel.php') )
    include('../models/VIEW_SoloConsultaModel.php');
...
class VIEW_SoloConsultaController{
    private $model;

    public function __construct(){
        $this->model = new  VIEW_SoloConsultaModel();
    }
