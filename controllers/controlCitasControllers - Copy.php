         ...
         $sms_cant="";
          ...
          if (is_array($sms_pos) ) {
             if (count($sms_pos)>0) {
                ...
                // echo "<pre>";
                // print_r( $sms_pos['cantidad']['cantidad']  );          
                // echo "</pre>";   
             } 
          }
			...
			$idmed="med-".$results->data[$i]['codclien']."-".$i;
      		$tabla .="<td align='center'><select id=".$idmed."  class='medicos form-control'  >";
	        ...
	        $tabla .="
              ...
              <div class='acciones' style='display:inline'>
                ...
                <button type='button' data-toggle='modal' data-target='.bd-sms-modal' style='width: 33%;margin-left: 1px; margin-top: 0px; float: left;' id="."msg".$idx." class='btn btn-default btn-xs btn-block sms  $class_btn_disabled'>
