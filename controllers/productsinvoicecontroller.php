...
$dbTable="VIEW_Mfactura_1 a";
$field="CONVERT(VARCHAR(10),a.fechafac,110) fechafac,a.numfactu,a.nombres,a.impuesto1,a.TotImpuesto,a.Medico,a.statfact,a.subtotal,a.descuento,a.total,a.monto_flete,a.id,a.Status,a.usuario,a.codmedico,a.Historia, (Select Case When sum(b.monto) IS NULL then 0 else  sum(b.monto) End from Mpagos b Where b.numfactu=a.numfactu and b.tipo_doc='01' and id_centro=1 ) paid  ";
