...
try {
  if (!include('../../models/MpagosModel.php') )
    include('../models/MpagosModel.php');
...
class MpagosController{
    private $model;

    public function __construct(){
        $this->model = new  MpagosModel();
    }
    ...
    public function del($numfactu,$id_centro,$tipo_doc) {
        return $this->model->del($numfactu,$id_centro,$tipo_doc);
    } 
