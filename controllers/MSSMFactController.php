...
try {
  if(!include('../../models/MSSMFactModel.php'))
         include('../models/MSSMFactModel.php');
} catch (Exception $e) {
  var_dump($e)  ;
}


class MSSMFactController{
    private $model;

    public function __construct(){
        $this->model = new  MSSMFactModel();
    }
    ...
    public function paginationUDF($longPage,$links,$className,$query){
           return $this->model->paginationUDF($longPage,$links,$className,$query);   
    }
