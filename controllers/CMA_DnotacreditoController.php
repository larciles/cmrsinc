...
try {
    if(!include('../../models/CMA_DnotacreditoModel.php'))
    include('../models/CMA_DnotacreditoModel.php');
...
class CMA_DnotacreditoController{
    private $model;

    public function __construct(){
        $this->model = new  CMA_DnotacreditoModel();
    }
