...
class MysqlConn{
	...
	try {
            ...
            self::$db = new PDO( 'mysql:host='.MYSQL_HOST.';dbname='.MYSQL_DBNAME.';port='.MYSQL_PORT.';charset='.MYSQL_CHAR, MYSQL_USER, MYSQL_PASS );
    ...
    public static function getConnection_my() {
