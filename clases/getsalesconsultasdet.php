...
require_once '../clases/paginator.class.php';
  ...
  $from    =" FROM  VentasDiariasCMACST a INNER JOIN MDocumentos  b ON a.doc = b.codtipodoc  ";
  $where   =" WHERE a.fechafac between '$fecha' AND '$fecha' AND a.cod_subgrupo = 'CONSULTA' and  a.statfact=3 "; 
