...
function pdfReporteCitados(){
    ...
    window.open('repsercitados.php?fecha='+fecha+'&usuario='+usuario+'&idempresa='+'C'+'&titulo_reporte='+'SERVICIOS CITADOS'+'&fecha2='+fecha2,'Servicios Citados', '_blank');
...
function getSCitados(fecha_cita,usuario,fecha_cita2){
    ...
    var items="";
    var ajxmed = $.post( "../../clases/getserrepcitados.php",{ fecha_cita ,usuario,fecha_cita2}, function(data) { 
