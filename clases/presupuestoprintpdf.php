...
$pdf->SetY(($pdf->GetY()+5)); 
$pdf->Text(25, $pdf->GetY(), 'PRESUPUESTO' ,1,0,'C',0);
...
if ($theTax!==0) {  
        $pdf->SetY(($pdf->GetY()+5)); 
        $pdf->Text(12,  $pdf->GetY(),str_pad("Impuesto", 39, " ", STR_PAD_LEFT)." $".str_pad(number_format((float)$resP[0]['TotImpuesto'], 2, '.', ''), 7, " ", STR_PAD_LEFT),0,0,'C');    
 }
