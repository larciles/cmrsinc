...
class VIEW_SoloConsultaModel extends Model{
    
    public function __construct()
    {
       $this->db_table='VIEW_SoloConsulta';
    }
    ...
    public function read($idkey='') {
        $this->query=($idkey!='')?"SELECT * FROM ".$this->db_table." Where Codmedico='$idkey' " : "SELECT * FROM ".$this->db_table."  ";
        $this->get_query();
