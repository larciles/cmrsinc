...
class MpagosModel extends Model{
    
    public function __construct()
    {
       $this->db_table='Mpagos';
    }
    ...
    public function del($numfactu,$id_centro,$tipo_doc) {
        $this->query = "DELETE FROM ".$this->db_table." WHERE  numfactu='$numfactu' and id_centro = '$id_centro' and tipo_doc = '$tipo_doc'  ";
        $this->set_query();
    } 
