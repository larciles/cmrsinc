...
class DisplaserModel extends Model{
    
    public function __construct()
    {
       $this->db_table='displaser';
    }
    ...
    public function update($_data = array()) {
       ...
       $rc= $this->query = "UPDATE ".$this->db_table." SET  $fields WHERE $where  ";            
		$this->set_query();
        // $rowsaffected=$this->fetchColumn();
        // $rowsaffected=$this->rowCount();
         return $rc;

    } 

    public function delete($_data = array()) {
        //$fieldarray= array();        
        $condarray= array();        
    ...
    public function readWhere($_data = array() ) {
        $condarray= array();                
        $array_where = $_data['where'];
